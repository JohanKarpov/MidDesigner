...
const MANIFEST_URL = 'images/minigen-game/manifest.json';
let _manifest = null;
 ...
 */
export async function showMiniGenPopup({ allowedTags, autoSelectMs = 0 } = {}) {
    let manifest;
    try {
    ...
    const basePath = `images/minigen-game/minigen-${group.tag}-`;
    ...
    return new Promise(resolve => {
        ...
        requestAnimationFrame(() => overlay.classList.add('minigen-overlay--visible'));
        ...
        function finish(result, chosenCellEl, spawnCoords) {
            ...
            if (chosenCellEl) {
                ...
                // Fade overlay after collapse finishes
                setTimeout(() => {
